...
llvm::cl::opt<unsigned>
    opt_max_mem("so-max-mem",
                llvm::cl::desc("Superoptimizer: max memory (aprox)"),
...
llvm::cl::opt<bool> opt_print_dot(
    "so-dot",
    llvm::cl::desc("Superoptimizer: print .dot file with CFG of each function"),
    llvm::cl::init(false));
