...
entry:
  ...
  %4 = tail call <32 x i16> @llvm.x86.avx512.pmaddubs.w.512(<64 x i8> %1, <64 x i8> %3) #3
  ...
  %10 = tail call <32 x i16> @llvm.x86.avx512.pmaddubs.w.512(<64 x i8> %7, <64 x i8> %9) #3
  %11 = bitcast <32 x i16> %10 to <8 x i64>
  %vecinit3.i = shufflevector <8 x i64> %5, <8 x i64> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %vecinit3.i61 = shufflevector <8 x i64> %5, <8 x i64> undef, <4 x i32> <i32 7, i32 6, i32 5, i32 4>
  %vecinit3.i65 = shufflevector <8 x i64> %11, <8 x i64> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %vecinit3.i69 = shufflevector <8 x i64> %11, <8 x i64> undef, <4 x i32> <i32 7, i32 6, i32 5, i32 4>
  ...
  %16 = tail call <16 x i16> @llvm.sadd.sat.v16i16(<16 x i16> %add.i71, <16 x i16> %add.i70) #3
...
declare <32 x i16> @llvm.x86.avx512.pmaddubs.w.512(<64 x i8>, <64 x i8>) #1
