; CHECK: shufflevector <4 x half> %a, <4 x half> <half 0xH2000, half 0xH2000, half 0xH0000, half 0xH0000>, <4 x i32> <i32 3, i32 2, i32 1, i32 0>; CHECK: shufflevector <4 x i16> %a, <4 x i16> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
